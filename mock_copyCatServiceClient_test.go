...
// AddLearnerToRaftGroup provides a mock function with given fields: ctx, in, opts
func (_m *mockCopyCatServiceClient) AddLearnerToRaftGroup(ctx context.Context, in *pb.AddRaftRequest, opts ...grpc.CallOption) (*pb.AddRaftResponse, error) {
...
// AddVoterToRaftGroup provides a mock function with given fields: ctx, in, opts
func (_m *mockCopyCatServiceClient) AddVoterToRaftGroup(ctx context.Context, in *pb.AddRaftRequest, opts ...grpc.CallOption) (*pb.AddRaftResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
